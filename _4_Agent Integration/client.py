...
if __name__ == "__main__":
    token_client = Client(base_url="http://127.0.0.1:8002")
    ...
    triage_client = Client(base_url="http://localhost:8002")
    #  
    try:
        triage_client_response = triage_client.post("ask-logistics", 
                            data={"question":"do we have any bangadtes in kisumu center"},
